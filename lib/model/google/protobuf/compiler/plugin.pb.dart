...
class Version extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Version', package: const $pb.PackageName('google.protobuf.compiler'), createEmptyInstance: create)
...
class CodeGeneratorRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CodeGeneratorRequest', package: const $pb.PackageName('google.protobuf.compiler'), createEmptyInstance: create)
    ..pPS(1, 'fileToGenerate')
    ..aOS(2, 'parameter')
    ..aOM<Version>(3, 'compilerVersion', subBuilder: Version.create)
    ..pc<$3.FileDescriptorProto>(15, 'protoFile', $pb.PbFieldType.PM, subBuilder: $3.FileDescriptorProto.create)
  ;
  ...
  CodeGeneratorRequest copyWith(void Function(CodeGeneratorRequest) updates) => super.copyWith((message) => updates(message as CodeGeneratorRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CodeGeneratorResponse_File extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CodeGeneratorResponse.File', package: const $pb.PackageName('google.protobuf.compiler'), createEmptyInstance: create)
    ..aOS(1, 'name')
...
class CodeGeneratorResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CodeGeneratorResponse', package: const $pb.PackageName('google.protobuf.compiler'), createEmptyInstance: create)
    ..aOS(1, 'error')
    ..pc<CodeGeneratorResponse_File>(15, 'file', $pb.PbFieldType.PM, subBuilder: CodeGeneratorResponse_File.create)
    ..hasRequiredFields = false
  ;
  ...
  CodeGeneratorResponse copyWith(void Function(CodeGeneratorResponse) updates) => super.copyWith((message) => updates(message as CodeGeneratorResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
